...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/void/common/hopcoderSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { VoidSettingsState } from '../../../../../../../workbench/contrib/void/common/hopcoderSettingsService.js'
...
import { IhopcoderSettingsService } from '../../../../../../../workbench/contrib/void/common/hopcoderSettingsService.js';
...
import { IhopcoderCommandBarService } from '../../../hopcoderCommandBarService.js'
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IhopcoderSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		hopcoderCommandBarService: accessor.get(IhopcoderCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, hopcoderCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		hopcoderCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		hopcoderCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IhopcoderSettingsService: accessor.get(IhopcoderSettingsService),
		...
		IhopcoderModelService: accessor.get(IhopcoderModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IhopcoderCommandBarService: accessor.get(IhopcoderCommandBarService),
...
export const useCommandBarState = () => {
	...
	const commandBarService = accessor.get('IhopcoderCommandBarService')
