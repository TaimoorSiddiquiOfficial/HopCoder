...
import { mountVoidSettings } from './react/out/hopcoder-settings-tsx/index.js'
...
class hopcoderSettingsPane extends EditorPane {
	...
	constructor(
		...
		super(hopcoderSettingsPane.ID, group, telemetryService, themeService, storageService);
	}
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(hopcoderSettingsPane, hopcoderSettingsPane.ID, nls.localize('hopcoderSettingsPane', "Void\'s Settings Pane")),
