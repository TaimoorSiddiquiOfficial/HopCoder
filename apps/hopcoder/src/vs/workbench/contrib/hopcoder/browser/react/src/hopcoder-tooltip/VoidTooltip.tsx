 ...
 * To use:
 * 1. Mount a Tooltip with some id eg id='hopcoder-tooltip'
 * 2. Add data-tooltip-id="hopcoder-tooltip" and data-tooltip-content="Your tooltip text" to any element
 */
export const VoidTooltip = () => {
	...
	return (
		...
		<>
			<style>
				{`
				#hopcoder-tooltip, #hopcoder-tooltip-orange, #hopcoder-tooltip-green, #hopcoder-tooltip-ollama-settings, #hopcoder-tooltip-provider-info {
					font-size: 12px;
					padding: 0px 8px;
					border-radius: 6px;
					z-index: 999999;
				...
				#hopcoder-tooltip-orange {
					background-color: #F6762A;
					color: white;
				}

				#hopcoder-tooltip-green {
					background-color: #228B22;
					color: white;
				}

				#hopcoder-tooltip-ollama-settings, #hopcoder-tooltip-provider-info {
					background-color: var(--vscode-editor-background);
					color: var(--vscode-input-foreground);
				}
			...
			/>
			<Tooltip
				id="hopcoder-tooltip-orange"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="hopcoder-tooltip-green"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="hopcoder-tooltip-ollama-settings"
				border='1px solid rgba(100,100,100,.2)'
				opacity={1}
			...
			<Tooltip
				id="hopcoder-tooltip-provider-info"
				border='1px solid rgba(100,100,100,.2)'
				opacity={1}
				delayShow={50}
