...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IhopcoderModelService hopcoderModelService: IhopcoderModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IhopcoderCommandBarService private readonly commandBarService: IhopcoderCommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				await hopcoderModelService.initializeModel(uri)
				const { model } = await hopcoderModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = hopcoderModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.hopcoderSettingsService.state.globalSettings.includeToolLintErrors ?
