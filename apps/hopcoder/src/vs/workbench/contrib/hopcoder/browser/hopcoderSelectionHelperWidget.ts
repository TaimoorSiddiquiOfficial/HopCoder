...
import { mountVoidSelectionHelper } from './react/out/hopcoder-editor-widgets-tsx/index.js';
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	...
	constructor(
		...
		@IhopcoderSettingsService private readonly _hopcoderSettingsService: IhopcoderSettingsService
	) {
		super();
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		// rerender
		const enabled = this._hopcoderSettingsService.state.globalSettings.showInlineSuggestions
