...
export interface IhopcoderModelService {
...
export const IhopcoderModelService = createDecorator<IhopcoderModelService>('voidhopcoderModelService');

class hopcoderModelService extends Disposable implements IhopcoderModelService {
	_serviceBrand: undefined;
	static readonly ID = 'voidhopcoderModelService';
...
registerSingleton(IhopcoderModelService, hopcoderModelService, InstantiationType.Eager);
