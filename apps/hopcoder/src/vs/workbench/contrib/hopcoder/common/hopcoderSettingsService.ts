...
export interface IhopcoderSettingsService {
...
export const IhopcoderSettingsService = createDecorator<IhopcoderSettingsService>('hopcoderSettingsService');
class hopcoderSettingsService extends Disposable implements IhopcoderSettingsService {
...
registerSingleton(IhopcoderSettingsService, hopcoderSettingsService, InstantiationType.Eager);
